...
CREATE TABLE `Paste` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `pasteDescription` VARCHAR(191) NOT NULL,
    `pasteName` VARCHAR(191) NOT NULL,
    `pasteContent` VARCHAR(191) NOT NULL,

    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `Pastebackup` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `dataName` VARCHAR(191) NOT NULL,
    `dataDesc` VARCHAR(191) NOT NULL,
    `dataContent` VARCHAR(191) NOT NULL,
