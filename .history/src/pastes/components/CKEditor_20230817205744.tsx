...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, ImageToolbar, TextTransformation, TableToolbar, Table, List, ImageResize, BlockQuote, Essentials, ClipBoard, PasteFromOffice, MediaEmbed, Indent, IndentBlock, Base64UploadAdapter, Context, CodeBlock } = editorRef.current || {}

  useEffect(() => {
    editorRef.current = {
      @ckeditor/ckeditor5-react: require("/ckeditor/build/ckeditor.js"),
