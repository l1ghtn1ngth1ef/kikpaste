...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, CodeBlock, Context, Base64UploadAdapter, IndentBlock, Indent, MediaEmbed,  } = editorRef.current || {}
