...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, ImageToolbar, TextTransformation, TableToolbar, Table, List, ImageResize  } = editorRef.current || {}
  ...
  useEffect(() => {
    editorRef.current = {
      ...
      Image: require("/ckeditor/build/ckeditor.js"),
