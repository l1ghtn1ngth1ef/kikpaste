...
const NewEditor = () => {
  ...
  const { DecoupledEditor, Clipboard, Essentials, BlockQuote, ImageResize, TabImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, CodeBlock, Context, Base64UploadAdapter, IndentBlock, Indent, MediaEmbed, PasteFromOffice  } = editorRef.current || {}
