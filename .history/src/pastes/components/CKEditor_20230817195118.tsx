...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, CodeBlock, Context, Base64UploadAdapter } = editorRef.current || {}

  useEffect(() => {
    editorRef.current = {
      Base64UloadAdapter: require("/ckeditor/build/ckeditor.js"),
