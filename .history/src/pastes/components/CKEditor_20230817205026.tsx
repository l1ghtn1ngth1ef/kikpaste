...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, ImageToolbar, TextTransformation, TableToolbar, Table  } = editorRef.current || {}
