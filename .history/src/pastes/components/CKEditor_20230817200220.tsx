...
const NewEditor JSX.Element = () => {
  ...
  const { DecoupledEditor, Clipboard, Essentials, BlockQuote, ImageResize, Table, TableToolbar, List, TextTransformation, ImageToolbar, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, CodeBlock, Context, Base64UploadAdapter, IndentBlock, Indent, MediaEmbed, PasteFromOffice  } = editorRef.current || {}
