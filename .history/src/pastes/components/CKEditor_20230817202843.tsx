...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, Context, PasteFromOffice, ClipBoard, Essentials, BlockQuote, ImageResize, Table, TableToolbar, List, TextTransformation, ImageToolbar, Indent, MediaEmbed, CodeBlock, Base64UploadAdapter, IndentBlock } = editorRef.current || {}

  useEffect(() => {
    editorRef.current = {
      DecoupledEditor: require("@ckeditor/ckeditor5-build-decoupled-document/src/decouplededitor.js"),
      ...
      TextTransformation: require("/ckeditor/build/ckeditor.js"),
      ImageToolbar: require("/ckeditor/build/ckeditor.js"),
