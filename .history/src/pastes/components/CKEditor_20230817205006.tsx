...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, ImageToolbar, TextTransformation  } = editorRef.current || {}
  ...
  useEffect(() => {
    editorRef.current = {
      ...
      Tab: require("/ckeditor/build/ckeditor.js"),
