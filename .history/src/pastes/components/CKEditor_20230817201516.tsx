...
const NewEditor = () => {
  ...
  const { DecoupledEditor, ImageUpload, Link, Alignment, Strikethrough, Underline, Italic, Bold, Paragraph, ImageStyle, Heading, Font, Context, CodeBlock, PasteFromOffice, ClipBoard, Essentials, BlockQuote, ImageResize, Table, TableToolbar, List, TextTransformation, ImageToolbar, Indent, MediaEmbed, CodeBlock, Base64UploadAdapter, IndentBlock, Link, Alignment  } = editorRef.current || {}
