        ...
        <main className={styles.main}>
          <div className={styles.wrapper}>
            <div className={styles.header}>
              ...
              <div>
                <form>
                  pasteName:<input type="text" name="pasteName" />
                  pasteDesc:<input type="text" name="pasteDescription" />
                  pasteContent:<input type="hidden" name="pasteContent" ppasteContent={data} />
                  <CKeditor
                    name="pasteContent"
