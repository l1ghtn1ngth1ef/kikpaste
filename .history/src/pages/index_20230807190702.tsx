        ...
        <main className={styles.main}>
          <div className={styles.wrapper}>
            <div className={styles.header}>
              ...
              <div>
                <form>
                  pasteName:<input type="text" name="pasteName"></input>
                  pasteDesc:<input type="text" name="pasteDescription"></input>
                  pasteContent:<input type="text" name="pasteDescription"></input>
                  <CKeditor
                    name="description"
