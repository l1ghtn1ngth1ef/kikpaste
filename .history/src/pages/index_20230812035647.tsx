...
import CKeditor from "src/pastes/components/Editor"
...
const Editor = dynamic(() => import("src/pastes/components/Editor"), { ssr: false })
            ...
            <div className={styles.header}>
              ...
              <div>
                ...
                >
                  ...
                  pasteContent:
                  <input type="hidden" name="pasteContent" placeholder="passteContent" type="text" />
