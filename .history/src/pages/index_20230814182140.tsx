...
import { Table, TableProperties } from "@ckeditor/ckeditor5-table"
/*
 * This file is just for a pleasant getting started page for your new app.
 * You can delete everything in here and start from scratch if you like.
 */
const Engine = dynamic(() => import('@ckeditor/ckeditor5-engine'), {
  ssr: false                                 // ^^^^^^^
})
const CKEditorComponent = dynamic(() => import('@ckeditor/ckeditor5-table'), {
  ssr: false                                 // ^^^^^^^
})
const UserInfo = () => {
            ...
            <div className={styles.header}>
              <div className={styles.logo}>
                <svg viewBox="0 0 165 66">
                  ...
                  <path d="M42.4727 33.2822H31.7398C27.6555 33.2 822 23.8086 31.3626 21.3528 28.0991L10.7656 14.0297C10.5656 13.7638 10.5354 13.4068 10.688 13.1111L16.7908 1.28696C17.0836 0.719654 17.8684 0.652924 18.2528 1.16266L42.4727 33.2822Z"></path>
                </svg>
              </div>
              <div>
                <form>
