...
function NewPastePage() {
  ...
  const handleSubmit = async (values) => {
    ...
    console.log("paste Value!", e.target.value);
  ...
  return (
    <>
        ...
        <LabeledTextField className={values && 'filled'} name="pasteContent" label="Paste Content" placeholder="Paste Content"type="text"/>

        {/* template: <__component__ name="__fieldName__" label="__Field_Name__" placeholder="__Field_Name__"  type="__inputType__" /> */}

        <CKEditor editor={DecoupledEditor} data={data}
