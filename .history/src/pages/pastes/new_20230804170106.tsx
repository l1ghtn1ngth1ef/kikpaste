...
function NewPastePage() {
  ...
  const inputHandler = (event, editor, data) => {
      ...
      <div>
        <Form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <CKEditor id="inputText" editor={DecoupledEditor} schema={CreatePasteSchema}
              onChange={async (values) => {const data = editor.getData();setTextEditor(data)}}
            />
          </div>
