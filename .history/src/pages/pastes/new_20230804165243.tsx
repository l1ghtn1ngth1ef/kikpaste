      ...
      <div>
        <Form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <CKEditor id="inputText" editor={ClassicEditor}data={setData} schema={CreatePasteSchema}
            onReady={(editor) => {
            const data = editor.getData();setTextEditor(data)}}
            onChange={(event, editor) => {const data = editor.getData(); const data = {setData: textEditor};(data);
            }}
            />
          </div>
