      ...
      <div>
        <Form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <CKEditor id="inputText" editor={DecoupledEditor} data={textEditor} schema={CreatePasteSchema}onChange={ (event, editor) => {const data = editor.getData();setTextEditor(data)}}
