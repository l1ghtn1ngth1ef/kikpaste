...
function NewPastePage() {
  ...
  const handleSubmit = async (values) => {
    const paste = await CreatePasteMutation(values);await router.push(Routes.ShowPastePage({pasteId: paste.id}));console.log("Pressed Button!");                        console.log( { event, editor, data } );
