...
const handler = async (req: { query: { webhookId: any }; method: any }, res: { setHeader: (arg0: string, arg1: string) => void; end: (arg0: string) => void; status: (arg0: number) => { (): any; new(): any; send: { (arg0: { error: string }): void; new(): any }; json: { (arg0: { Status: string }): void; new(): any }; end: { (arg0: string): void; new(): any } } }) => {
