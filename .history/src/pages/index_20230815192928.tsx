...
const Context = dynamic(() => import("ckeditor5-custom-build"), {
  ssr: false,
})
...
const Home: BlitzPage = () => {
  ...
  const { CKEditor, DecoupledEditor, CKEditor } = editorRef.current || {}

  useEffect(() => {
    editorRef.current = {
      CKEditor: require("@ckeditor/ckeditor5-react").CKEditor, //Added .CKEditor
      DecoupledEditor: require("@ckeditor/ckeditor5-build-decoupled-document"),
      CKEditorContext: require("@ckeditor/ckeditor5-react").CKEditorContext, //Added .CKEditor
